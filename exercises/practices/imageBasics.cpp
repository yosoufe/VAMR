/* Taken from https://github.com/yosoufe/slambook2/blob/yousof/translate_to_english/ch5/imageBasics/imageBasics.cpp
 * to test the usabity of opencv in the docker image
 */
